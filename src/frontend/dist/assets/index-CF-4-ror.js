...
function AnnouncementBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "announcement-bar w-full py-2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm tracking-widest", children: "✦ Elevating Every Byte. ✦" }) });
}
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, rgba(76,111,255,0.15) 0%, rgba(122,77,255,0.2) 50%, rgba(216,75,255,0.15) 100%), #111827",
            border: "1px solid rgba(76,111,255,0.2)",
            boxShadow: "0 0 80px rgba(76,111,255,0.1), 0 0 160px rgba(122,77,255,0.08)"
          },
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest mb-4 gradient-text", children: "READY TO GROW?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-5xl lg:text-6xl font-black text-white mb-6 leading-tight", children: "Let's Work Together" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-lg font-medium mb-10 max-w-xl mx-auto", children: "Take the first step toward transforming your digital presence. Let's build something remarkable." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#0A0D16] border-t border-white/[0.06] py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-12 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl", children: "Gonexdigital" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-sm font-medium leading-relaxed max-w-xs", children: "Elevating Every Byte. We help businesses grow online through stunning design, smart marketing, and powerful digital strategies." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-bold text-base mb-5 tracking-wide", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-bold text-base mb-5 tracking-wide", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://tally.so/r/44LKKA",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: socialLinks.map((social) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: social.href,
            target: "_blank",
            ...
            children: [
              social.svg,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: social.label })
            ]
          },
          social.label
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/[0.06] pt-8 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#A7B2C8] text-sm font-medium", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Gonexdigital. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-xs font-medium", children: "Privacy Policy & Terms of Service coming soon." }),
        policyLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            "data-ocid": "footer.link",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, #4C6FFF 0%, #7A4DFF 50%, transparent 70%)",
                top: "-100px",
                right: "-100px"
              }
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, #41C8FF 0%, #4C6FFF 60%, transparent 70%)",
                bottom: "-50px",
                left: "-80px"
              }
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, #D84BFF 0%, #7A4DFF 60%, transparent 70%)",
                top: "40%",
                right: "20%"
              }
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `fade-in ${isInView ? "visible" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-px bg-gradient-to-r from-[#41C8FF] to-[#7A4DFF]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "Elevating Every Byte."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl lg:text-6xl font-black leading-tight text-white mb-6", children: [
              "We Build ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Websites, Brands" }),
              " ",
              "& Digital Growth"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-lg font-medium leading-relaxed mb-10 max-w-xl", children: "Gonexdigital helps businesses grow online through stunning design, smart marketing, and powerful digital strategies." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[480px] h-[480px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "radial-gradient(circle, rgba(76,111,255,0.5) 0%, rgba(122,77,255,0.3) 50%, transparent 70%)",
                      boxShadow: "0 0 80px rgba(76,111,255,0.4), 0 0 160px rgba(122,77,255,0.2)"
                    }
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: `sticky top-0 z-50 w-full transition-all duration-300 ${scrolled ? "bg-[#0B0F1A]/95 backdrop-blur-md border-b border-white/5 shadow-lg" : "bg-[#0B0F1A]/80 backdrop-blur-sm"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg tracking-tight", children: "Gonexdigital" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-8", children: links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
              "data-ocid": "nav.link",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-0.5 bg-white mb-1.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-0.5 bg-white mb-1.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-0.5 bg-white" })
              ]
            }
          )
        ] }),
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-[#0B0F1A]/98 border-t border-white/5 px-6 py-4 flex flex-col gap-4", children: [
...
const services = [
  {
    ...
    title: "SEO",
    description: "Dominate search rankings with data-driven SEO strategies that drive organic traffic and qualified leads to your business.",
  ...
  },
  {
    ...
    title: "Ads Marketing",
    description: "High-converting paid campaigns across Google, Meta, and more. Every rupee spent delivers measurable ROI.",
  ...
  },
  {
    ...
    description: "Build an engaged community with content that resonates. We handle strategy, creation, and daily management.",
  ...
  },
  {
    ...
    description: "Blazing-fast, pixel-perfect websites and apps built with modern tech. From landing pages to enterprise platforms.",
  ...
  },
  {
    ...
    description: "Visual identities that leave a lasting impression. Logos, branding, print, and digital design crafted with precision.",
...
function Services() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: [
          driftOrbs.map((orb) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
          ...
          serviceDots.map((dot) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                background: "conic-gradient(from 0deg, rgba(65,200,255,0.08), rgba(122,77,255,0.08), rgba(216,75,255,0.06), rgba(65,200,255,0.08))"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative z-10", ref: containerRef, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-center mb-16 fade-in ${isInView ? "visible" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest mb-3 gradient-text", children: "WHAT WE DO" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl lg:text-5xl font-black text-white", children: "Our Services" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] mt-4 text-base font-medium max-w-lg mx-auto", children: "End-to-end digital solutions crafted to grow your brand online." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
            services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": `services.item.${i + 1}`,
                className: `relative bg-[#111827] border border-white/[0.08] rounded-2xl p-8 card-glow transition-all duration-500 cursor-default fade-in fade-in-delay-${Math.min(i + 1, 5)} ${isInView ? "visible" : ""}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-xl mb-3", children: service.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-sm font-medium leading-relaxed", children: service.description })
                ]
              },
              service.title
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `hidden lg:flex relative bg-gradient-to-br from-[#4C6FFF]/10 to-[#D84BFF]/10 border border-white/[0.08] rounded-2xl p-8 items-center justify-center fade-in fade-in-delay-5 ${isInView ? "visible" : ""}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "gradient-text font-black text-5xl mb-2", children: "∞" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] font-semibold text-sm", children: "Limitless Possibilities" })
                ] })
              }
            )
          ] })
...
function useCounter(target, duration = 2e3, active = false) {
...
const particles = [
  ...
  { id: "p6", top: "68%", left: "62%", size: 2, delay: 3, dur: 10, ci: 2 },
...
function StatCounter({
  ...
  const count = useCounter(target, 2e3, active);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-5xl font-black text-white mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "gradient-text", children: [
      count,
      suffix2
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] font-semibold text-sm tracking-wide", children: label })
  ] });
}
function Stats() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: [
          orbs.map((orb) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                right: 0,
                height: "1px",
                background: "linear-gradient(90deg, transparent 0%, #4C6FFF 30%, #7A4DFF 60%, transparent 100%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `bg-[#111827] border border-white/[0.08] rounded-2xl p-12 mb-16 fade-in ${isInView ? "visible" : ""}`,
              style: {
                background: "linear-gradient(135deg, rgba(76,111,255,0.08) 0%, rgba(122,77,255,0.05) 50%, rgba(216,75,255,0.08) 100%), #111827",
                boxShadow: "inset 0 0 80px rgba(76,111,255,0.05)"
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  StatCounter,
                  {
                    target: 150,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-center mb-12 fade-in fade-in-delay-1 ${isInView ? "visible" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest mb-3 gradient-text", children: "OUR WORK" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-black text-white", children: "Portfolio" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] mt-3 text-base font-medium", children: "A glimpse into what we create. Full portfolio coming soon." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: portfolioItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `portfolio.item.${i + 1}`,
              className: `relative rounded-2xl overflow-hidden group cursor-default fade-in fade-in-delay-${Math.min(i + 2, 5)} ${isInView ? "visible" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-[#0B0F1A]/90 via-[#0B0F1A]/30 to-transparent flex flex-col justify-end p-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-base mb-1", children: item.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#41C8FF] text-xs font-semibold tracking-wide", children: "Images coming soon" })
                ] })
              ]
            },
            item.title
...
const testimonials = [
  {
    ...
    review: "Gonexdigital transformed our online presence completely. Our organic traffic tripled in just 4 months, and the website they built is absolutely stunning. Professional, responsive, and truly results-driven."
  },
  {
    name: "Arjun Mehta",
    role: "Founder, TechLaunch India",
    avatar: "https://i.pravatar.cc/80?img=3",
    review: "Working with Gonexdigital was a game changer. Their social media strategy turned our brand into a recognized name in the industry. The team is creative, on-time, and always goes the extra mile."
  },
  {
    name: "Sneha Patel",
    role: "Marketing Head, StyleHive",
    avatar: "https://i.pravatar.cc/80?img=5",
    review: "The ads campaigns Gonexdigital ran for us delivered a 5x return on ad spend. Their transparent pricing and clear communication made the entire experience seamless. Highly recommend!"
  }
];
function Testimonials() {
  const { ref, isInView } = useInView();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 px-6", ref, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `text-center mb-16 fade-in ${isInView ? "visible" : ""}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest mb-3 gradient-text", children: "CLIENT STORIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl lg:text-5xl font-black text-white", children: "What Clients Say" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl font-black gradient-text leading-none", children: "“" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-sm font-medium leading-relaxed flex-1", children: t.review }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 pt-2 border-t border-white/[0.06]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: t.avatar,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm", children: t.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-xs font-medium", children: t.role })
            ] })
          ] })
        ]
      },
...
const reasons = [
  {
    ...
    description: "Every strategy is backed by data. We focus on metrics that actually matter — leads, conversions, and revenue.",
    color: "#41C8FF"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    description: "We don't do mediocre. Our creative team pushes boundaries to deliver stunning visuals and compelling narratives.",
    color: "#D84BFF"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    description: "Deadlines are sacred. We plan meticulously and deliver on schedule — every time, without compromising quality.",
    color: "#4C6FFF"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    description: "You're not just a client — you're a partner. We listen, adapt, and stay fully transparent throughout the process.",
    color: "#7A4DFF"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    description: "No hidden fees, no surprises. Clear packages and honest quotes so you can plan with confidence.",
    color: "#41C8FF"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    description: "From branding to development to marketing — one team, one vision, complete digital transformation.",
    color: "#D84BFF"
  }
];
const stars = [
...
function WhyChoose() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      className: "py-24 px-6 relative overflow-hidden",
      style: {
        background: "linear-gradient(180deg, transparent 0%, rgba(76,111,255,0.03) 50%, transparent 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: [
          ambientBlobs.map((blob) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-center mb-16 fade-in ${isInView ? "visible" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest mb-3 gradient-text", children: "THE GONEXDIGITAL DIFFERENCE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl lg:text-5xl font-black text-white", children: "Why Choose Gonexdigital?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] mt-4 text-base font-medium max-w-lg mx-auto", children: "We combine strategy, creativity, and technology to deliver results that exceed expectations." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: reasons.map((reason, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `why.item.${i + 1}`,
              className: `bg-[#111827] border border-white/[0.08] rounded-2xl p-8 card-glow transition-all duration-500 cursor-default fade-in fade-in-delay-${Math.min(i + 1, 5)} ${isInView ? "visible" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-lg mb-3", children: reason.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] text-sm font-medium leading-relaxed", children: reason.description })
              ]
            },
            reason.title
          )) })
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0B0F1A]", children: [
...
function PolicyPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0B0F1A]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-white/[0.06] py-4 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-black gradient-text", children: "G" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg", children: "Gonexdigital" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-4xl mx-auto px-6 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black text-white mb-2", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#A7B2C8] text-sm font-medium mb-8", children: [
        "Last updated: ",
        lastUpdated
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] font-medium leading-relaxed mb-10 text-base", children: intro }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10", children: sections.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-[#111827] border border-white/[0.08] rounded-2xl p-8",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold text-xl mb-4", children: section.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#A7B2C8] font-medium leading-relaxed text-sm", children: section.content })
          ]
        },
        section.title
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-white/[0.06] py-6 px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#A7B2C8] text-sm font-medium", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Gonexdigital. All rights reserved."
    ] }) })
      ...
      sections: [
        {
          ...
          content: "We may collect personal information such as your name, email address, phone number, and company name when you contact us, request a quote, or fill out our project inquiry form. We also collect non-personal information such as browser type, IP address, and pages visited through cookies and analytics tools."
        },
        {
          title: "2. How We Use Your Information",
          content: "We use collected information to respond to your inquiries, provide and improve our services, send project-related communications, and occasionally share relevant updates or offers (with your consent). We do not sell, trade, or rent your personal information to third parties."
        },
        {
        ...
        },
        {
          ...
          content: "We may use trusted third-party services (such as payment processors, analytics platforms, and communication tools) that have access to your information solely to perform tasks on our behalf. These parties are obligated not to disclose or use your information for any other purpose."
        },
        {
          title: "6. Your Rights",
          content: "You have the right to access, correct, or request deletion of any personal information we hold about you. To exercise these rights, please contact us directly. We will respond to all legitimate requests within a reasonable timeframe."
        },
        {
          title: "7. Changes to This Policy",
          content: "Gonexdigital reserves the right to update this Privacy Policy at any time. We will notify users of significant changes by updating the date at the top of this page. Your continued use of our services following any changes constitutes your acceptance of the revised policy."
        },
        {
          title: "8. Contact Us",
          content: "If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us through the project inquiry form at https://tally.so/r/44LKKA or via our website contact section."
        }
      ]
    }
  );
    ...
    PolicyPage,
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "All digital deliverables (design files, website access, code repositories, reports) are delivered via agreed channels such as email, cloud storage links, or direct platform access. Gonexdigital provides all deliverables in agreed file formats. Source files are provided upon full payment confirmation."
        },
        {
          title: "7. Dispute Resolution",
          content: "In the event of a dispute regarding deliverables or payments, both parties agree to engage in good-faith negotiations to resolve the matter. If a resolution cannot be reached within 30 days, the matter may be referred to mediation before any legal proceedings are initiated."
        },
        {
          title: "8. Contact for Refund Requests",
          content: "To initiate a refund request or discuss concerns about project delivery, please contact us through the project inquiry form at https://tally.so/r/44LKKA. All requests will be acknowledged within 2 business days and resolved within 14 business days."
        }
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    PolicyPage,
    {
      ...
      sections: [
        ...
        {
          title: "2. Services",
          content: "Gonexdigital provides digital marketing, web development, graphic design, and related services as agreed upon in individual project contracts or service agreements. The specific scope, timeline, and deliverables of each project will be defined in a separate Statement of Work (SOW) or proposal accepted by both parties."
        },
        {
          title: "3. Intellectual Property",
          content: "Upon full payment, clients receive ownership of final deliverables specifically created for their project. Gonexdigital retains ownership of all preliminary designs, concepts, tools, frameworks, and proprietary processes used in delivering the services. We reserve the right to showcase completed work in our portfolio unless otherwise agreed in writing."
        },
        {
          title: "4. Payment Terms",
          content: "Payment terms are outlined in individual project agreements. Standard policy requires an advance deposit before work commences, with the remaining balance due upon project completion. Gonexdigital reserves the right to pause or terminate work if payments are significantly overdue, without liability to the client."
        },
        {
          title: "5. Confidentiality",
          content: "Both parties agree to maintain confidentiality of any proprietary information shared during the course of the project. Gonexdigital will not disclose client business information, strategies, or data to third parties without explicit written consent, except where required by law."
        },
        {
          title: "6. Limitation of Liability",
          content: "Gonexdigital shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our services. Our total liability in any matter arising out of or related to these terms shall not exceed the total fees paid by the client in the three months preceding the claim."
        },
        {
          title: "7. Termination",
          content: "Either party may terminate a service agreement with 14 days written notice. In the event of termination, the client is responsible for payment for all work completed up to the termination date. Deposits are non-refundable unless Gonexdigital fails to begin work within the agreed timeframe."
        },
        {
          title: "8. Governing Law",
          content: "These Terms and Conditions are governed by and construed in accordance with applicable laws. Any disputes arising under these terms shall be subject to the exclusive jurisdiction of the courts in the applicable jurisdiction."
        }
      ]
    }
  );
